...
module.exports = () => [
  ...
  },
  {
    ...
    answer: "Votre facture est à envoyer directement au contact de l'Université transmis lors de votre conventionnement. \
    Dans les 30 jours après la réception de cette facture, l'université effectuera le remboursement \
    des séances que vous avez réalisées et déclarées.",
  },
  {
  ...
  },
  {
    ...
    answer: "Dans le cas où vous exercez en tant qu'employé pour une structure, \
    c'est cette dernière qui doit émettre la facture que vous transmettrez à l'université pour \
    le remboursement des séances. La structure qui vous emploie devra ensuite vous régler \
    le montant récuppéré.",
  },
];
